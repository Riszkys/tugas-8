...
<body>
    ...
    <!-- form start -->
    <form class="form" method="POST" action="dataibukandung.php" style="padding-top: 2rem;">
        <div class="judulform">
            <h5>DATA AYAH KANDUNG</h5>
        </div>
        <div class="label mb-3">
            <label for="" class="nomor-label"> 34. </label>
            <label class="judul-label" for=""> Nama Ayah Kandung </label>
            <input class="input" type="text" name="nama_ayah">
        </div>
        <div class="label mb-3">
            <label for="" class="nomor-label"> 35. </label>
            <label class="judul-label" for=""> Tahun Lahir </label>
            <input class="input" type="number" name="tahun_lahir_ayah" style="width: 6rem ;">
        </div>
        <div class="label mb-3">
            <label for="" class="nomor-label"> 36. </label>
            <label class="judul-label" for=""> Pendidikan</label>
            <input class="input" type="text" name="pendidikan_ayah" style="width: 6rem ;">
        ...
        <div class="label mb-3">
            <label for="" class="nomor-label"> 37. </label>
            <label class="judul-label" for=""> Pekerjaaan</label>
            <input class="input" type="text" name="pekerjaan_ayah" style="width: 6rem ;">
        ...
        <div class="label mb-3">
            <label for="" class="nomor-label"> 38. </label>
            <label class="judul-label" for=""> Penghasilan Bulanan</label>
            <input class="input" type="text" name="penghasilan_bulanan_ayah" style="width: 6rem ;">
        ...
        <div class="label mb-3">
            <label for="" class="nomor-label"> 39. </label>
            <label class="judul-label" for=""> Berkebutuhan Khusus</label>
            <input class="input" type="text" name="kebutuhan_khusus_ayah" style="width: 6rem ;">
        ...
        <!-- <button type="submit" class="btn btn-primary" style="padding-right: 1rem;"> <a href="dataibukandung.php" style="color: #000;"> Next</a> </button> -->
    </form>
    <?php
    $_SESSION['formayahkandung_data'] = $_POST;
    ?>
    <!-- form end -->
